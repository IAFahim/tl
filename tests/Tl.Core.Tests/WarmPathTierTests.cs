...
public class WarmPathTierTests
{
    ...
    [
        ...
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "ApplyRowsForward", 4, null, WarmMode.Optimize),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "ApplyRowsBackward", 4, null, WarmMode.Optimize),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "AdvanceRowsForward", 3, null, WarmMode.Optimize),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "AdvanceRowsBackward", 3, null, WarmMode.Optimize),
        ...
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<LaneTrack, LaneClip>.Advance), 4, "ReadOnlySpan`1", WarmMode.Inline),
