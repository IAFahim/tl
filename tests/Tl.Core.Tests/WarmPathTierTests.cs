...
public class WarmPathTierTests
{
    ...
    [
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.IsFolded), 1, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.Gather), 1, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.Apply), 4, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.Apply), 5, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.ApplySlot), 4, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.ApplySlot), 5, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.FoldedView), 1, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.ApplyRecords), 4, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.ApplyRecords), 5, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "ApplyRows", 5, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "AdvanceRows", 4, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "ApplyRowsCore", 4, null, WarmMode.Optimize),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "AdvanceRowsCore", 3, null, WarmMode.Optimize),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.Advance), 3, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<,>.Advance), 4, null, WarmMode.Optimize),
        ...
        new(typeof(TimelineSetLane<LaneTrack, LaneClip>), nameof(TimelineSetLane<,>.Seek), 2, null, WarmMode.Inline),
        new(typeof(TimelineSetLane<LaneTrack, LaneClip>), nameof(TimelineSetLane<,>.Apply), 1, null, WarmMode.Optimize),
        new(typeof(TimelineSetLane<LaneTrack, LaneClip>), nameof(TimelineSetLane<,>.Apply), 2, null, WarmMode.Optimize),
        new(typeof(TimelineSetLane<LaneTrack, LaneClip>), nameof(TimelineSetLane<,>.ApplySlot), 2, null, WarmMode.Optimize),
        new(typeof(TimelineSetLane<LaneTrack, LaneClip>), nameof(TimelineSetLane<,>.ApplySlot), 3, null, WarmMode.Optimize),
        ...
        new(typeof(TimelineSetLane<LaneTrack, LaneClip>), "GatherMixed", 9, null, WarmMode.Optimize),
        ...
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<,>.Apply), 4, null, WarmMode.Inline),
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<,>.Apply), 5, null, WarmMode.Inline),
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<,>.Advance), 3, "UInt16", WarmMode.Inline),
        ...
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<,>.ResolveChunk), 4, null, WarmMode.Optimize),
        new(typeof(Timeline<LawLane>), nameof(Timeline<>.Apply), 3, null, WarmMode.Inline),
        new(typeof(Timeline<LawLane>), nameof(Timeline<>.Apply), 4, null, WarmMode.Inline),
        new(typeof(Timeline<LawLane>), nameof(Timeline<>.Advance), 2, null, WarmMode.Inline),
        new(typeof(Timeline<LawLane>), nameof(Timeline<>.Advance), 3, null, WarmMode.Inline),
        new(typeof(TimelineLane<LawLane>), ".ctor", 2, null, WarmMode.Inline),
        new(typeof(TimelineLane<LawLane>), nameof(TimelineLane<>.Advance), 3, null, WarmMode.Optimize),
        new(typeof(TimelineLane<LawLane>), nameof(TimelineLane<>.Apply), 4, null, WarmMode.Optimize),
        new(typeof(TimelineLane<LawLane>), nameof(TimelineLane<>.Apply), 1, null, WarmMode.Optimize),
        ...
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<,>.Apply), 4, null, WarmMode.Optimize),
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<,>.Advance), 3, null, WarmMode.Optimize),
        new(typeof(Timeline<LaneTrack, LaneClip>), nameof(Timeline<,>.Advance), 4, "ReadOnlySpan`1", WarmMode.Inline),
