...
public class WarmPathTierTests
{
    ...
    [
        ...
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<LaneTrack, LaneClip>.Step), 3, null, WarmMode.Inline),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), nameof(TimelineSet<LaneTrack, LaneClip>.Step), 4, null, WarmMode.Optimize),
        new(typeof(TimelineSet<LaneTrack, LaneClip>), "StepRow", 8, null, WarmMode.Optimize),
        ...
        new(typeof(TimelineSetLane<LaneTrack, LaneClip>), "ApplyUniformSegment", 8, null, WarmMode.Optimize),
        ...
        new(typeof(Timeline<LawLane>), nameof(Timeline<LawLane>.Step), 2, null, WarmMode.Inline),
        new(typeof(Timeline<LawLane>), nameof(Timeline<LawLane>.Step), 3, null, WarmMode.Inline),
        new(typeof(TimelineLane<LawLane>), ".ctor", 2, null, WarmMode.Inline),
        new(typeof(TimelineLane<LawLane>), nameof(TimelineLane<LawLane>.Step), 3, null, WarmMode.Optimize),
        ...
        new(typeof(Timeline), nameof(Timeline.Step), 3, "ReadOnlySpan`1", WarmMode.Inline),
        new(typeof(Timeline), nameof(Timeline.Step), 4, "ReadOnlySpan`1", WarmMode.Optimize),
        new(typeof(Timeline), nameof(Timeline.Step), 3, "TimelineAsset", WarmMode.Inline),
        new(typeof(Timeline), nameof(Timeline.Step), 4, "TimelineAsset", WarmMode.Inline),
        new(typeof(Timeline), nameof(Timeline.Step), 3, "UInt16", WarmMode.Inline),
        new(typeof(Timeline), nameof(Timeline.Step), 4, "UInt16", WarmMode.Optimize),
        new(typeof(Timeline), "StepRecords", 4, "UInt32", WarmMode.Inline),
        new(typeof(Timeline), "StepRecordsForward", 4, "UInt16", WarmMode.Inline),
        new(typeof(Timeline), "StepRecordsBackward", 4, "UInt16", WarmMode.Inline),
        ...
        new(typeof(LaneOps), nameof(LaneOps.StepForward), 6, null, WarmMode.Optimize),
        new(typeof(LaneOps), nameof(LaneOps.StepBackward), 6, null, WarmMode.Optimize),
        new(typeof(LaneOps), nameof(LaneOps.StepRows), 7, null, WarmMode.Optimize),
        new(typeof(LaneOps), "StepForwardWide", 5, null, WarmMode.Inline),
        new(typeof(LaneOps), "StepBackwardWide", 5, null, WarmMode.Inline),
        new(typeof(Lane<LaneTrack, LaneClip>), nameof(Lane<LaneTrack, LaneClip>.Apply), 4, null, WarmMode.Optimize),
        new(typeof(Lane<LaneTrack, LaneClip>), nameof(Lane<LaneTrack, LaneClip>.Step), 3, null, WarmMode.Optimize),
