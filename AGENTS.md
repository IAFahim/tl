...
dotnet build tests/Tl.Core.Tests/Tl.Core.Tests.csproj -c Release -m:1 -p:NuGetAudit=false -p:TlChecked=true -o artifacts/checked-tests
dotnet test artifacts/checked-tests/Tl.Core.Tests.dll -p:NuGetAudit=false
```
