...
internal static unsafe class TimelineKernel_5fdcdd591ae77a36ee99fc2f80358e7d5cc9c8ec09389334d98a04bbf04a067b
{
    [ModuleInitializer]
    internal static void Install() =>
        TimelineKernels.Register(0x367AE71A59DDDC5F, 0x7D8E35802FFC99EE, 0x34933809ECC8C95C, 0x7B064AF0BB048AD9, &Tick);
    ...
    static unsafe void Execute(bool reverse, uint tick, uint gameTick, long cycle, FrameFlags flags, int row, byte* asset, int* heads, void** columns)
    {
        ...
        if (!reverse)
        {
            TimelineKernels.Chain(heads[1], reverse, scratch, asset + 144u, gameTick, tick, cycle, flags, columns, row);
            TimelineKernels.Chain(heads[2], reverse, scratch, asset + 176u, gameTick, tick, cycle, flags, columns, row);
