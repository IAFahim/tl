...
public static class BakeOracle
{
    ...
    public static byte[] BakeJsonLegacy(string json, BakerAssemblyResolver? resolver = null)
    {
...
internal sealed class ValuePoolSet
{
    ...
    private static int CompareImages(byte[] left, byte[] right)
    {
