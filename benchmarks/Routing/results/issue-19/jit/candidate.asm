...
G_M000_IG20:                ;; offset=0x0217
       xor      eax, eax
 
G_M000_IG21:                ;; offset=0x0219
       jmp      G_M000_IG36
 
G_M000_IG22:                ;; offset=0x021E
       mov      rax, qword ptr [rbx]
       movzx    rcx, word  ptr [rbx+0x0C]
       movzx    rdx, byte  ptr [rbx+0x0E]
       cmp      r13d, 3
...
G_M000_IG24:                ;; offset=0x0283
       add      rax, rcx
       js       SHORT G_M000_IG25
       test     rax, rax
       jg       SHORT G_M000_IG25
       test     r15d, r15d
       jne      SHORT G_M000_IG25
...
G_M000_IG29:                ;; offset=0x0305
       add      rax, rcx
       js       SHORT G_M000_IG30
       test     rax, rax
       jg       SHORT G_M000_IG30
       test     r15d, r15d
       jne      SHORT G_M000_IG30
...
G_M000_IG30:                ;; offset=0x031B
       xor      eax, eax
 
G_M000_IG31:                ;; offset=0x031D
       jmp      G_M000_IG36
...
G_M000_IG32:                ;; offset=0x0322
       ...
       jne      SHORT G_M000_IG35
       test     rax, rax
       jl       SHORT G_M000_IG35
       test     rax, rax
       jg       SHORT G_M000_IG35
       test     rcx, rcx
       jle      SHORT G_M000_IG33
       mov      rdx, rcx
       neg      rdx
       mov      rdi, 0x7FFFFFFFFFFFFFFF
       add      rdx, rdi
...
G_M000_IG34:                ;; offset=0x0387
       add      rax, rcx
       js       SHORT G_M000_IG35
       test     rax, rax
       jg       SHORT G_M000_IG35
       test     r15d, r15d
       jne      SHORT G_M000_IG35
...
G_M000_IG35:                ;; offset=0x039D
       xor      eax, eax
 
G_M000_IG36:                ;; offset=0x039F
       movzx    rax, al
 
G_M000_IG37:                ;; offset=0x03A2
       add      rsp, 16
       pop      rbx
       pop      r13
       pop      r14
...
G_M000_IG38:                ;; offset=0x03AF
       xor      eax, eax
 
G_M000_IG39:                ;; offset=0x03B1
       add      rsp, 16
       pop      rbx
       pop      r13
       pop      r14
...
RWD00  	dd	00000302h ; case G_M000_IG32
       	dd	00000280h ; case G_M000_IG27
       	dd	000001FEh ; case G_M000_IG22
       	dd	0000017Ch ; case G_M000_IG17
       	dd	00000165h ; case G_M000_IG16
       	dd	0000014Eh ; case G_M000_IG15
       	dd	00000137h ; case G_M000_IG14
       	dd	00000120h ; case G_M000_IG13
       	dd	00000109h ; case G_M000_IG12
       	dd	000000F2h ; case G_M000_IG11
       	dd	000000DBh ; case G_M000_IG10
       	dd	000000C4h ; case G_M000_IG09
       	dd	000000ADh ; case G_M000_IG08
       	dd	00000096h ; case G_M000_IG07
       	dd	0000007Fh ; case G_M000_IG06
       	dd	00000068h ; case G_M000_IG05
...
G_M000_IG03:                ;; offset=0x0034
       ...
       test     eax, eax
       je       G_M000_IG278
       test     byte  ptr [(reloc 0x7fc3361eebf0)], 1
       je       G_M000_IG280
...
G_M000_IG04:                ;; offset=0x0062
       ...
       cmp      edi, 256
       jae      G_M000_IG281
       mov      rsi, 0x7FC32D402748
       movzx    r12, byte  ptr [rsi+rdi]
       cmp      r12d, 1
       jne      G_M000_IG257
