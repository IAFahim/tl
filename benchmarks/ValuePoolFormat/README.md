...
- `BakeCacheKey.ToolVersion` is `tlbake-bake-v4` (bumped in #168 with the row repack; `tlbake-bake-v3` covered #155's pooling). Assets with `Version != 3` are rejected at load (`TLB magic or version invalid`).
