...
internal static unsafe class TimelineKernel_0fecece0fa33b6ac165d69d4817d31f3e0737f9eed09fac2a74be88315ca5b99
{
    [ModuleInitializer]
    internal static void Install() =>
        TimelineKernels.Register(0xACB633FAE0ECEC0F, 0xF3317D81D4695D16, 0xC2FA09ED9E7F73E0, 0x995BCA1583E84BA7, &Tick);
    ...
    static unsafe void Execute(bool reverse, uint tick, uint gameTick, long cycle, FrameFlags flags, int row, byte* asset, int* heads, void** columns)
    {
        ...
        if (!reverse)
        {
            ...
            TimelineKernels.Chain(heads[1], reverse, scratch, asset + 160u, gameTick, tick, cycle, flags, columns, row);
            TimelineKernels.Chain(heads[0], reverse, scratch, asset + 192u, gameTick, tick, cycle, flags, columns, row);
        }
        else
        {
            TimelineKernels.Chain(heads[0], reverse, scratch, asset + 192u, gameTick, tick, cycle, flags, columns, row);
