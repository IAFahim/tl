...
internal static unsafe class TimelineKernel_0fecece0fa33b6ac165d69d4817d31f3e0737f9eed09fac2a74be88315ca5b99
{
    ...
    static unsafe void Execute(bool reverse, uint tick, uint gameTick, long cycle, FrameFlags flags, int row, byte* asset, int* heads, void** columns)
    {
        if (!reverse)
        {
            ...
            TimelineKernels.Chain(heads[1], reverse, asset + 160u, gameTick, tick, cycle, flags, columns, row);
            TimelineKernels.Chain(heads[0], reverse, asset + 192u, gameTick, tick, cycle, flags, columns, row);
        }
        else
        {
            TimelineKernels.Chain(heads[0], reverse, asset + 192u, gameTick, tick, cycle, flags, columns, row);
