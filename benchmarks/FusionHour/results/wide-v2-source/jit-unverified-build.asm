...
G_M000_IG03:                ;; offset=0x003C
       mov      rdi, 0x7FF9390E3948
       call     CORINFO_HELP_NEWSFAST
       mov      gword ptr [rbp-0x28], rax
       mov      edi, 837
       mov      rsi, 0x7FF938F41A30
...
G_M000_IG19:                ;; offset=0x04CC
       mov      rdi, 0x7FF9395793DC
       call     CORINFO_HELP_COUNTPROFILE32
       jmp      G_M000_IG27
 
G_M000_IG20:                ;; offset=0x04E0
       mov      rdi, 0x7FF9395793E0
       call     CORINFO_HELP_COUNTPROFILE32
       mov      eax, dword ptr [rbp-0x78]
       add      eax, -29
       mov      eax, eax
...
G_M000_IG17:                ;; offset=0x0448
       mov      rdi, 0x7FF939593084
       call     CORINFO_HELP_COUNTPROFILE32
       jmp      G_M000_IG25
 
G_M000_IG18:                ;; offset=0x045C
       mov      rdi, 0x7FF939593088
       call     CORINFO_HELP_COUNTPROFILE32
       mov      eax, dword ptr [rbp-0x78]
       add      eax, -29
       mov      eax, eax
...
; rbp based frame
; fully interruptible
; with Synthesized PGO: fgCalledCount is 84307
; 0 inlinees with PGO data; 4 single block inlinees; 0 inlinees without PGO data
...
G_M000_IG30:                ;; offset=0x02A0
       cmp      r10d, 7
       jb       SHORT G_M000_IG32
 
G_M000_IG31:                ;; offset=0x02A6
       vmovss   xmm0, dword ptr [rsi]
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD16]
       vmovss   dword ptr [rsi], xmm0
       jmp      G_M000_IG09
 
G_M000_IG32:                ;; offset=0x02BB
       vmovss   xmm0, dword ptr [rsi]
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD00]
       vmovss   dword ptr [rsi], xmm0
       lea      edi, [r10-0x03]
...
G_M000_IG35:                ;; offset=0x036D
       mov      rax, qword ptr [rdi]
 
G_M000_IG36:                ;; offset=0x0370
       add      rsp, 8
       pop      rbx
       pop      r14
       pop      r15
...
G_M000_IG37:                ;; offset=0x037B
       vmovss   xmm0, dword ptr [rsi]
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD00]
       vmovss   dword ptr [rsi], xmm0
       jmp      G_M000_IG10
 
G_M000_IG38:                ;; offset=0x0390
       mov      rdi, 0x7FF93932A730
       call     CORINFO_HELP_NEWSFAST
       mov      r14, rax
       mov      edi, 999
...
G_M000_IG13:                ;; offset=0x00F2
       cmp      r14d, 29
       jb       SHORT G_M000_IG15
 
G_M000_IG14:                ;; offset=0x00F8
       lea      edx, [r14-0x1D]
       vxorps   xmm1, xmm1, xmm1
       vcvtsi2ss xmm1, xmm1, rdx
...
G_M000_IG15:                ;; offset=0x0126
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD04]
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD28]
       jmp      G_M000_IG31
 
G_M000_IG16:                ;; offset=0x013B
       cmp      r14d, 3
       jb       SHORT G_M000_IG20
 
G_M000_IG17:                ;; offset=0x0141
       cmp      r14d, 7
       jb       SHORT G_M000_IG19
 
G_M000_IG18:                ;; offset=0x0147
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD32]
       jmp      G_M000_IG30
...
G_M000_IG20:                ;; offset=0x0182
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD36]
       jmp      G_M000_IG31
 
G_M000_IG21:                ;; offset=0x018F
       mov      ecx, 1
       cmp      esi, 599
       je       G_M000_IG05
 
G_M000_IG22:                ;; offset=0x01A0
       mov      edx, ebx
       mov      esi, r15d
       shl      rsi, 32
       or       rdx, rsi
...
G_M000_IG24:                ;; offset=0x023B
       mov      ebx, r11d
       sub      ebx, edx
 
G_M000_IG25:                ;; offset=0x0240
       mov      esi, r15d
       neg      esi
       add      esi, 0xFFFF
       movsxd   rdx, esi
...
G_M000_IG28:                ;; offset=0x0284
       cmp      r14d, 321
       jb       SHORT G_M000_IG35
 
G_M000_IG29:                ;; offset=0x028D
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD36]
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD04]
...
G_M000_IG31:                ;; offset=0x02A5
       mov      ebx, r10d
       mov      esi, r14d
       mov      edx, r11d
       add      r8, 4
 
G_M000_IG32:                ;; offset=0x02B2
       dec      r9d
       je       G_M000_IG21
 
G_M000_IG33:                ;; offset=0x02BB
       mov      r10d, dword ptr [rcx+r8]
       mov      r11d, r10d
       imul     r11, r11, 0x1B4E81B5
       shr      r11, 38
...
G_M000_IG34:                ;; offset=0x02F1
       cmp      r14d, esi
       setb     bl
       movzx    rbx, bl
       jmp      G_M000_IG25
 
G_M000_IG35:                ;; offset=0x02FF
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD00]
       jmp      SHORT G_M000_IG30
 
G_M000_IG36:                ;; offset=0x0309
       cmp      r14d, 600
       jae      SHORT G_M000_IG31
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD32]
       jmp      SHORT G_M000_IG31
 
G_M000_IG37:                ;; offset=0x031C
       call     [System.ThrowHelper:ThrowArgumentOutOfRangeException()]
       int3     
 
G_M000_IG38:                ;; offset=0x0323
       mov      rdi, 0x7FF9390E3948
       call     CORINFO_HELP_NEWSFAST
       mov      rbx, rax
       mov      edi, 837
...
G_M000_IG10:                ;; offset=0x00C2
       cmp      r14d, 200
       jb       G_M000_IG19
 
G_M000_IG11:                ;; offset=0x00CF
       cmp      r14d, 515
       jae      SHORT G_M000_IG07
 
G_M000_IG12:                ;; offset=0x00D8
       cmp      r14d, 321
...
G_M000_IG14:                ;; offset=0x00F1
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD16]
 
G_M000_IG15:                ;; offset=0x00F9
       mov      ebx, r11d
       mov      r8d, r14d
       mov      esi, r15d
       add      r9, 4
 
G_M000_IG16:                ;; offset=0x0106
       dec      r10d
       je       G_M000_IG34
 
G_M000_IG17:                ;; offset=0x010F
...
G_M000_IG18:                ;; offset=0x0145
       cmp      r14d, r8d
       setb     bl
       movzx    rbx, bl
       jmp      G_M000_IG09
 
G_M000_IG19:                ;; offset=0x0153
       cmp      r14d, 76
       jb       SHORT G_M000_IG23
 
G_M000_IG20:                ;; offset=0x0159
       cmp      r14d, 123
       jb       SHORT G_M000_IG22
 
G_M000_IG21:                ;; offset=0x015F
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD00]
       jmp      SHORT G_M000_IG15
 
G_M000_IG22:                ;; offset=0x0169
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD12]
       lea      esi, [r14-0x4C]
       vxorps   xmm1, xmm1, xmm1
...
G_M000_IG28:                ;; offset=0x01F8
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD12]
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD16]
       jmp      G_M000_IG15
 
G_M000_IG29:                ;; offset=0x020D
       cmp      r14d, 3
       jb       SHORT G_M000_IG33
...
G_M000_IG31:                ;; offset=0x0219
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD04]
       jmp      G_M000_IG14
 
G_M000_IG32:                ;; offset=0x0226
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD08]
       lea      esi, [r14-0x03]
       vxorps   xmm1, xmm1, xmm1
       vcvtsi2ss xmm1, xmm1, rsi
...
G_M000_IG33:                ;; offset=0x0254
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD08]
       jmp      G_M000_IG15
 
G_M000_IG34:                ;; offset=0x0261
       mov      ecx, 1
       cmp      r8d, 599
       je       G_M000_IG05
 
G_M000_IG35:                ;; offset=0x0273
       mov      esi, ebx
       mov      edx, edx
       shl      rdx, 32
       or       rdx, rsi
...
G_M000_IG11:                ;; offset=0x02C3
       mov      rdi, 0x7FF9395FA2BC
       call     CORINFO_HELP_COUNTPROFILE32
       jmp      G_M000_IG19
 
G_M000_IG12:                ;; offset=0x02D7
       mov      rdi, 0x7FF9395FA2C0
       call     CORINFO_HELP_COUNTPROFILE32
       mov      eax, dword ptr [rbp-0x1C]
       add      eax, -29
       mov      eax, eax
...
G_M000_IG08:                ;; offset=0x00A2
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD00]
 
G_M000_IG09:                ;; offset=0x00AA
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD04]
 
G_M000_IG10:                ;; offset=0x00B2
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD08]
 
G_M000_IG11:                ;; offset=0x00BA
       mov      edx, edx
       mov      esi, esi
       shl      rsi, 32
       or       rdx, rsi
...
G_M000_IG13:                ;; offset=0x0144
       cmp      r9d, r8d
       setb     sil
       movzx    rsi, sil
 
G_M000_IG14:                ;; offset=0x014F
       mov      r8d, r15d
       neg      r8d
       add      r8d, 0xFFFF
       movsxd   r8, r8d
...
G_M000_IG15:                ;; offset=0x0184
       cmp      r9d, 47
       jb       G_M000_IG26
 
G_M000_IG16:                ;; offset=0x018E
       cmp      r9d, 200
       jb       SHORT G_M000_IG21
 
G_M000_IG17:                ;; offset=0x0197
       cmp      r9d, 515
       jae      SHORT G_M000_IG20
 
G_M000_IG18:                ;; offset=0x01A0
       cmp      r9d, 321
       jae      G_M000_IG08
 
G_M000_IG19:                ;; offset=0x01AD
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD12]
       jmp      G_M000_IG10
...
G_M000_IG21:                ;; offset=0x01D4
       cmp      r9d, 76
       jb       SHORT G_M000_IG25
 
G_M000_IG22:                ;; offset=0x01DA
       cmp      r9d, 123
       jb       SHORT G_M000_IG24
 
G_M000_IG23:                ;; offset=0x01E0
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD12]
       jmp      G_M000_IG11
 
G_M000_IG24:                ;; offset=0x01ED
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD04]
       add      r9d, -76
       vxorps   xmm1, xmm1, xmm1
       vcvtsi2ss xmm1, xmm1, r9
...
G_M000_IG25:                ;; offset=0x0223
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD32]
       jmp      SHORT G_M000_IG23
 
G_M000_IG26:                ;; offset=0x022D
       cmp      r9d, 11
       jb       SHORT G_M000_IG30
 
G_M000_IG27:                ;; offset=0x0233
       cmp      r9d, 18
       jb       G_M000_IG11
...
G_M000_IG30:                ;; offset=0x0275
       cmp      r9d, 3
       jb       SHORT G_M000_IG34
 
G_M000_IG31:                ;; offset=0x027B
       cmp      r9d, 7
       jb       SHORT G_M000_IG33
 
G_M000_IG32:                ;; offset=0x0281
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD16]
       jmp      G_M000_IG10
 
G_M000_IG33:                ;; offset=0x028E
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD00]
       add      r9d, -3
       vxorps   xmm1, xmm1, xmm1
       vcvtsi2ss xmm1, xmm1, r9
...
G_M000_IG34:                ;; offset=0x02BC
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD00]
       jmp      G_M000_IG11
 
G_M000_IG35:                ;; offset=0x02C9
       mov      rdi, 0x7FF9390E3948
       call     CORINFO_HELP_NEWSFAST
       mov      rbx, rax
       mov      edi, 837
...
; rbp based frame
; partially interruptible
; with Synthesized PGO: fgCalledCount is 11936
; 0 inlinees with PGO data; 1 single block inlinees; 0 inlinees without PGO data
...
G_M000_IG10:                ;; offset=0x00D9
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD04]
 
G_M000_IG11:                ;; offset=0x00E1
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD08]
 
G_M000_IG12:                ;; offset=0x00E9
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD12]
 
G_M000_IG13:                ;; offset=0x00F1
       mov      edx, edx
       mov      esi, esi
       shl      rsi, 32
       or       rdx, rsi
...
G_M000_IG16:                ;; offset=0x0178
       cmp      r9d, r8d
       setb     sil
       movzx    rsi, sil
       jmp      G_M000_IG05
 
G_M000_IG17:                ;; offset=0x0188
       mov      r8d, 5
       jmp      G_M000_IG06
 
G_M000_IG18:                ;; offset=0x0193
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD16]
       jmp      G_M000_IG12
 
G_M000_IG19:                ;; offset=0x01A0
       cmp      r9d, 600
       jae      G_M000_IG13
       vaddss   xmm0, xmm0, dword ptr [reloc @RWD20]
       jmp      G_M000_IG13
