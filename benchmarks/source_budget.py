...
src_ok = budget("src", "src", limit=300_000)
tools_ok = budget("shipped-tools", "tools/Tl.Gen.Tlb", "tools/Tl.Bake", limit=235_000)
raise SystemExit(0 if src_ok and tools_ok else 1)
